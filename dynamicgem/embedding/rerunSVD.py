...
class rerunSVD(StaticGraphEmbedding):
    """Timers: rerun Singular Value Decomposition
    
    Timers perfomrs dynamic graph embedding by
    utilizing the SVDS decomposition of incremental graph with a bound 
    ...
    def learn_embedding(self, graph=None):
        ...
        """
        timers = tu.rerunSVD(self._datafile, self._K // 2, self._Theta, self._datatype)
